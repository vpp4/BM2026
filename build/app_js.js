...
const st = {q:'', tags:new Set(), day:-1, star:false, favOnly:false, now:false,
            ver:false, guest:false, noWoo:false, music:false, t0:0, t1:1440, walk:99, limit:200};
...
function walkOf(e){ if(!e.p) return null; if(e._w!==undefined&&e._h===home) return e._w;
 e._h=home; e._w=Math.round(hav(home,e.p)/80); return e._w }
...
function match(o){
 ...
 if(st.walk<99){ const w=walkOf(e); if(w!==null && w>st.walk) return false }
...
function render(){
 ...
 for(const o of show){
  ...
  h+='<li class="ev">'+
   ...
   (w!==null?'<span class="wk">'+w+' min walk</span>':'<span class="wk">walk n/a</span>')+
